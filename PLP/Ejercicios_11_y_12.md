...
_Se pide completar la siguiente tabla con el an´alisis de los nonogramas predefinidos. Indicar qué consultas se usaron para averiguar cada uno de los datos. Si algún nonograma no puede ser analizado, indicar el motivo._
