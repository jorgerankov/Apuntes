...
Entiendo que no puede haber mas de un ciclo dirigido primero y principal porque ningun nodo puede tener como grado de salida un valor mayor a 1, dando a saber que no pueden formar mas de un ciclo dirigido debido a que no pueden apuntar a mas de un nodo a la vez. Esto implica que, para que haya mas de un ciclo dirigido y el grafo siga siendo conexo, uno de los nodos del ciclo dirigido debe apuntar tanto al nodo inicial de dicho ciclo (aquel que comenzó sin aristas entrantes) y, a su vez, apuntar hacia un nuevo nodo fuera del ciclo, tal que por ese nuevo camino también se forme otro ciclo dirigido, o ser parte de un ciclo dirigido y a su vez apuntar hacia otro nodo donde se forme un camino que tenga un nuevo ciclo dirigido. Ambas posibilidades hacen que dicho nodo tenga grado de salida mayor a 1 y contradiciendo la propiedad que hace que un digrafo tenga forma de ρ.