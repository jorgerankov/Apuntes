...
- Author code
- Test and debug changes in isolation
- Merge code into the larger app code and perform app testing
#### In a server-based deployment, this workflow is achieved by:
- Pulling down a local copy of the application
- Working locally through your IDE to code
- Testing and debugging code
- Checking changes into source control
![[Pasted image 20251227162305.png]]
![[Pasted image 20251227162657.png]]
